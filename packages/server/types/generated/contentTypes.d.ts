...
export interface ApiAnnouncementAnnouncement
  ...
  info: {
    description: 'Announcements for property residents';
...
export interface ApiAssetRequestAssetRequest
  ...
  info: {
    description: 'Requests from residents for assets';
...
export interface ApiAssetAsset extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Assets available for residents to request';
    displayName: 'Asset';
    pluralName: 'assets';
    singularName: 'asset';
  };
...
export interface ApiNotificationNotification
  ...
  info: {
    description: 'Notifications for users across all collections';
...
export interface ApiPlanPlan extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Subscription plans for property managers';
    displayName: 'Plan';
    pluralName: 'plans';
    singularName: 'plan';
  };
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Real estate properties managed by the system';
...
export interface ApiUnitTypeUnitType extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Types of units within a property';

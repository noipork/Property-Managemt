...
<template>
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <div v-else-if="errorMessage"
            ...
            <NuxtLink to="/maintenance" class="mt-4 text-sm text-primary-600 hover:underline">{{ t.backToMaintenance }}
            </NuxtLink>
        </div>
        ...
        <template v-else-if="request">
            ...
            <div class="flex items-start justify-between gap-4 transition-all duration-500"
                ...
                <div class="flex items-center gap-2 shrink-0">
                    <NuxtLink :to="`/maintenance/${maintenanceDocumentId}/edit`"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden transition-all duration-500 delay-200"
                        ...
                        <div class="p-4 border-b border-gray-200 dark:border-gray-800">
                            <h3
                                ...
                                <i class="ti-messages text-primary-500"></i>
                                {{ t.discussion }}
                        ...
                        <div ref="messagesContainer"
                            ...
                            <div v-if="!request.messages || request.messages.length === 0"
                                ...
                                <i class="ti-message-dots text-3xl mb-2"></i>
                            ...
                            <div v-for="msg in request.messages" :key="msg.id" class="flex gap-3"
                                ...
                                <div
                                    ...
                                    <i class="ti-user text-primary-500 text-xs"></i>
                                </div>
                        ...
                        <div class="p-4 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                            ...
                            <div v-if="selectedImages.length > 0" class="flex flex-wrap gap-2 mb-3">
                                <div v-for="(file, idx) in selectedImages" :key="idx"
                                    ...
                                    <button @click="removeSelectedImage(idx)"
                                        ...
                                        <i class="ti-close text-white text-[10px]"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="flex items-end gap-2">
                                ...
                                <button @click="selectImages" :disabled="selectedImages.length >= 5"
                                    class="p-2.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors disabled:opacity-40"
                                    :title="t.attachImage">
                                    <i class="ti-photo text-gray-500 dark:text-gray-400"></i>
                                </button>
                                <div class="flex-1 relative">
                                    <textarea v-model="newMessage" :placeholder="t.writeMessage" rows="1"
                                        @keydown="handleKeydown"
                                        class="w-full px-4 py-2.5 text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 resize-none max-h-32"></textarea>
                                </div>
                                <button @click="sendMessage"
                                    :disabled="isSendingMessage || (!newMessage.trim() && selectedImages.length === 0)"
                                    class="p-2.5 bg-primary-600 hover:bg-primary-700 disabled:opacity-50 rounded-xl transition-colors">
                                    <i v-if="isSendingMessage" class="ti-reload text-white animate-spin"></i>
                                    <i v-else class="ti-send text-white"></i>
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div v-if="request.estimatedCost || request.actualCost"
                        ...
                        <h3
                            class="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider flex items-center gap-2">
                            <i class="ti-receipt text-primary-500"></i>
                            {{ t.financial }}
                        </h3>
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">
                                    {{ t.deleteMaintenanceConfirm }} <strong class="text-gray-900 dark:text-white">{{
                                        request?.requestNumber }}</strong>{{ t.deleteMaintenanceConfirm2 }}
                                </p>
                            </div>
                        </div>

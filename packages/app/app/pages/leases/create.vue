...
async function submit() {
    ...
    try {
        ...
        setTimeout(() => router.push(`/leases/${data.data.documentId}`), 800)
    } catch (err: any) {
...
<template>
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-3 transition-all duration-500"
            ...
            <NuxtLink to="/leases" class="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors">

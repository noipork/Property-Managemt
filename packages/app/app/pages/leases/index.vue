    ...
    <div class="space-y-6">
        ...
        <div v-else-if="leases.length === 0" class="flex flex-col items-center justify-center py-20 text-center">
            <div class="w-16 h-16 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center mb-4">
                <i class="ti-file text-2xl text-gray-400"></i>
            </div>
            ...
            <div v-for="(lease, index) in leases" :key="lease.id"
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div
                        ...
                        <i class="ti-file text-xl text-primary-600 dark:text-primary-400"></i>
                    </div>
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p v-if="lease.resident" class="text-sm text-gray-500 dark:text-gray-400 truncate">
                            <i class="ti-user text-xs mr-1"></i>{{ lease.resident.username }}
                        ...
                        <p v-if="lease.property" class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">
                            <i class="ti-home text-xs mr-1"></i>{{ lease.property.name }}
                        </p>
                    </div>
                    ...
                    <div class="flex items-center gap-1 shrink-0">
                        <NuxtLink :to="`/leases/${lease.documentId}`" @click.stop
                        ...
                        <NuxtLink :to="`/leases/${lease.documentId}/edit`" @click.stop
